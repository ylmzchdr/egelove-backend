...
const MOCK_ONLINE_USERS = [
  ...
  { id: '5', name: 'Elif', avatar: 'https://unsplash.com', city: 'İstanbul' },
  { id: '6', name: 'Burak', avatar: 'https://unsplash.com', city: 'Ankara' },
  { id: '7', name: 'Zeynep', avatar: 'https://unsplash.com', city: 'Diyarbakır' },
  { id: '8', name: 'Hakan', avatar: 'https://unsplash.com', city: 'Trabzon' },
];
          ...
          >
            <div className="relative">
              <div className="w-14 h-14 rounded-full p-[2px] bg-gradient-to-tr from-purple-600 via-pink-500 to-blue-500 group-hover:scale-105 transition-transform duration-300">
                ...
                <img src={user.avatar} alt={user.name} className="w-full h-full object-cover rounded-full border-2 border-[#121420]" />
              </div>
