  ...
  const t = useMemo(() => {
    const translations: Record<string, Record<string, string>> = {
      ...
      AZ: {
        ...
        logout: "Çıxış",
        backHome: "ANA SƏHİFƏYƏ QAYIT",
        heroTitle: "BİRBİR CANLI",
        heroTitleAccent: "GÖRÜNTÜLÜ SÖHBƏT",
        heroDesc1: "Bəyənib uyğunlaşdığın insanlarla canlı görüntülü danış.",
        heroDesc2: "Yeni insanları yalnız mesajla deyil, üz-üzə tanımağın zövqünü yaşa.",
        safe: "Təhlükəsiz",
        safeSub: "Söhbətlər",
        real: "Həqiqi",
        realSub: "İnsanlar",
        ...
        closer: "Daha Yaxın",
        closerSub: "Əlaqələr",
        premiumFeature: "PREMIUM XÜSUSİYYƏTİ",
        unlimitedVideo: "Limitsiz görüntülü danışıq",
        readReceipt: "Oxundu məlumatı",
        boostProfile: "Profilini önə çıxar",
        adFree: "Reklamsız istifadə",
        goPremium: "PREMIUM-A KEÇ",
        premiumOnly: "Bu xüsusiyyət Premium üzvlüklə istifadə edilə bilər.",
        chatTitle: "Mesajlar",
        all: "Hamısı",
        new: "Yeni",
        online: "Onlayn",
        ...
        noMessage: "Hələ mesaj yoxdur",
        noMessageDesc: "Bəyəndiyin insanlarla uyğunlaşdıqda söhbətlərin burada görünəcək.",
        total: "Cəmi",
        conversations: "söhbət",
        onlineStatus: "Onlayn",
        premiumVideo: "Premium ilə Görüntülü Danış",
        today: "Bu gün",
        noConversationMessages: "Bu söhbətdə hələ mesaj yoxdur.",
        startChat: "Söhbətə başla",
        startChatDesc: "Soldan bir söhbət seç və uyğunlaşdığın şəxslə yazışmağa başla.",
        messagePlaceholder: "Mesajını yaz...",
        send: "GÖNDƏR",
        sending: "...",
        enterHint: "Enter ilə göndər • Shift + Enter ilə yeni sətir",
        moreFor: "Bunlar və daha çoxu üçün",
        premiumGo: "Premium-a keç!",
        premiumDesc: "Canlı görüntülü danışıq, oxundu məlumatı, profilini önə çıxarma, reklamsız istifadə və daha çox üstünlük səni gözləyir.",
        specialFilters: "Xüsusi filtrlər və daha çoxu",
        securePayment: "Təhlükəsiz və sürətli ödəniş",
      },
    };
