...
export default function Sidebar() {
  ...
  const copy = {
    TR: {
      ...
      settings: "Ayarlar",
      help: "Yardım Merkezi",
      platform: "EGELOVE.TR KALİTESİNDE GÜVENLİ DENEYİM",
    ...
    EN: {
      ...
      settings: "Settings",
      help: "Help Center",
      platform: "SECURE EGELOVE.TR EXPERIENCE",
      menu: "Control Center",
      account: "My Account",
      special: "Special",
      premiumText:
    ...
    RU: {
      ...
      settings: "Настройки",
      help: "Центр помощи",
      platform: "БЕЗОПАСНЫЙ ОПЫТ EGELOVE.TR",
    ...
    AR: {
      ...
      settings: "الإعدادات",
      help: "مركز المساعدة",
      platform: "تجربة EGELOVE.TR الآمنة",
      menu: "مركز التحكم",
      account: "حسابي",
      special: "مميز",
      premiumText:
