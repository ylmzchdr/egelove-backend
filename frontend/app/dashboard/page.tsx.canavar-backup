  ...
  return (
    <div className="min-h-screen bg-[#121420] text-white p-6 md:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* 🟢 Üst Başlık ve Karşılama Bölümü */}
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[10px] text-slate-500 hover:text-purple-400 cursor-pointer transition-colors font-medium">Tüm İlleri Gör</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* 🎥 1. KART: SESLİ & GÖRÜNTÜLÜ CANLI SOHBET KARTI (ZAFER SÜRÜMÜ) */}
          <Link href="/messages" className="block group">
            <div className="bg-gradient-to-br from-purple-900/40 to-slate-900/60 backdrop-blur-xl border border-purple-500/40 rounded-3xl p-6 shadow-xl shadow-purple-500/5 relative overflow-hidden h-full transform hover:scale-[1.01] transition-all duration-300">
              ...
              <p className="text-xs text-slate-300 leading-relaxed tracking-wide">
                Ege ve Akdeniz'in sıcaklığını sıfır gecikmeli sesli ve görüntülü odalarda bizzat hisset! WebRTC altyapısıyla kesintisiz, anlık ve 81 il genelinde sınırsız görüntülü flört deneyimi başarıyla devrede. Ortaklıkla başardık!
              </p>
            </div>
          </Link>

          {/* 📱 2. KART: GOOGLE PLAY & APP STORE KARTI */}
