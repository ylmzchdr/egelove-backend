...
setIsPremium(premiumStatus);
  ...
  return (
    <div className="min-h-screen bg-[#310D0C] text-[#2D1721]">
      ...
      {mobileMenuOpen && (
        <div
          className="fixed inset-0 z-[100] bg-[#310D0C] backdrop-blur-sm md:hidden"
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className={`h-10 px-3 rounded-xl border text-xs font-bold transition ${
                      lang === "TR"
                        ? "border-pink-400 bg-[#EC4899] text-white"
            ...
            <div className="max-w-[1280px] mx-auto">
              ...
              {tab === "received" && !isPremium && (
                <button
                  ...
                  className="group relative w-full overflow-hidden rounded-3xl border border-pink-400/40 bg-gradient-to-r from-[#D987A8] via-[#EFA3C0] to-[#E99AB9] p-5 md:p-6 mb-8 text-left transition-all duration-300 hover:border-pink-400/70 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-pink-500/15"
                >
                  ...
                  <div className="relative flex flex-col md:flex-row md:items-center gap-4 md:gap-5">
                    <div className="shrink-0 w-14 h-14 rounded-2xl bg-pink-500/15 border border-pink-400/40 flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
                  {visibleMatches.map((match) => {
                    ...
                    return (
                      <article
                        key={match.id}
                        className="group relative overflow-hidden rounded-3xl border border-pink-200 bg-[#310D0C] hover:border-pink-400/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-pink-500/10"
                      >
                        {/* IMAGE */}
                       <button
  onClick={() => {
...
>
  ...
  tab === "received" && !isPremium ? "blur-xl scale-105" : ""
                            ...
                            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-pink-500/20 via-pink-400/10 to-rose-500/10">
  ...
  {t.profile}
                            ...
                            {tab === "received" && !isMutual && (
                              <button
                                ...
                                className="flex-1 h-10 rounded-xl bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-400 hover:to-rose-400 text-xs font-bold transition shadow-lg shadow-pink-500/10 disabled:opacity-50 flex items-center justify-center gap-1.5"
                              >
    ...
    <nav className="space-y-1">
      {items.map((item) => {
        ...
        return (
          ...
          >
            {isActive && (
              <span className="absolute left-0 top-2 bottom-2 w-1 rounded-r-full bg-gradient-to-b from-pink-400 to-rose-500" />
            )}
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-pink-200 bg-gradient-to-br from-[#EFA3C0] to-[#D987A8] min-h-[360px] flex items-center justify-center px-6">
      ...
      <div className="relative text-center max-w-md">
        ...
        <p className="text-[15px] font-medium leading-6 text-[#6A3048] mb-7">{description}</p>
