...
export default function LikesPage() {
  ...
  const t = useMemo(() => {
    const translations: Record<string, Record<string, string>> = {
      ...
      AZ: {
        likes: "Bəyənmələr",
        subtitle: "Səni bəyənənlər və sənin bəyəndiklərin",
        likedYou: "Səni Bəyənənlər",
        youLiked: "Bəyəndiklərin",
        noOneLiked: "Hələ səni bəyənən yoxdur",
        noOneLikedDesc: "Profilini tamamla və SenVeBen-də daha çox insana görün.",
        youLikedNobody: "Hələ heç kimi bəyənməmisən",
        youLikedNobodyDesc: "Sənə uyğun insanları tap və marağını çəkən profillərə bax.",
        explore: "Sənə Uyğun İnsanı Tap",
        editProfile: "Profilimi Redaktə Et",
        profile: "Profilə Bax",
        respond: "Qarşılıq Ver",
        mutual: "Uyğunlaşdınız!",
        sendMessage: "Mesaj Göndər",
        online: "Onlayn",
        home: "Ana Səhifə",
        discover: "Sənə Uyğun İnsanı Tap",
        likesMenu: "Bəyənmələr",
        messages: "Mesajlar",
        premium: "Premium",
        myProfile: "Profilim",
        settings: "Ayarlar",
        notifications: "Bildirişlər",
        search: "Ad, şəhər və ya istifadəçi adı axtar...",
        login: "Daxil Ol",
        ...
        members: "üzv",
        location: "Məkan",
        premiumTitle: "Bu şəxs səni bəyəndi!",
        premiumDesc: "Şəklini görmək və kim olduğunu öyrənmək üçün Premium-a keç.",
        premiumButton: "Premium-a Keç",
        premiumPhoto: "Bu kimdir?",
      },
    };
