...
moreProfiles: "Больше профилей",
 ...
 dashboard: {
  ...
  findDesc: "Найдите участников по подходящим вам критериям",
  friendsDesc: "Общайтесь с участниками, с которыми вы совпали",
  loveGameDesc: "Знакомьтесь с новыми людьми через веселые вопросы",
},
