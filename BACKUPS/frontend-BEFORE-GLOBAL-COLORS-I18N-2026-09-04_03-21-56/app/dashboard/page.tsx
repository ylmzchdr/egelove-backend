        ...
        <main className="min-h-screen min-w-0 flex-1 overflow-x-hidden">
          <div className="w-full pl-0 pr-4 pb-10 pt-4 sm:pr-5 md:pr-6 lg:pr-7 xl:pr-8">
            ...
            <div className="mb-2 flex w-full flex-col items-center justify-center gap-3 text-center">
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-[#F6BA48]/70 bg-[#EFA3C0] px-4 py-1.5 backdrop-blur-md">
            ...
            <section className="grid w-full grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <Link href="/profile/edit" className="group min-w-0">
                <div className="h-full rounded-2xl border border-[#F6BA48]/70 bg-gradient-to-r from-[#EFA3C0] to-[#EFA3C0] p-5 transition-all hover:border-[#F6BA48] hover:shadow-lg hover:shadow-pink-500/10">
              ...
              <Link href="/search" className="group min-w-0">
                <div className="h-full rounded-2xl border border-[#F6BA48]/70 bg-[#EFA3C0] p-5 transition-all hover:bg-[#EFA3C0]">
                  <div className="flex items-center gap-4">

                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-[#F6BA48]/70 bg-[#EFA3C0]">
            ...
            <section className="mt-6 grid w-full grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <Link href="/messages" className="group block min-w-0">
                <div className="relative h-full overflow-hidden rounded-3xl border border-[#F6BA48]/70 bg-gradient-to-br from-[#EFA3C0] to-[#EFA3C0] p-6 shadow-xl shadow-pink-500/10 backdrop-blur-xl transition-all duration-300 hover:border-[#F6BA48]/60">
              ...
              {/* TELEFONA YÜKLE */}
              <div className="relative h-full min-w-0 overflow-hidden rounded-3xl border border-[#F6BA48]/70 bg-gradient-to-br from-[#EFA3C0] via-[#EFA3C0] to-[#EFA3C0] p-6 shadow-xl shadow-pink-500/10 backdrop-blur-xl">
                ...
                <div className="relative flex h-full flex-col">
                  ...
                  <div className="mb-4 flex items-center gap-4">
                    ...
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[#F6BA48]/70 bg-[#EFA3C0]">
                      ...
                      <span
                        className={`mt-1 inline-block rounded-md border px-2 py-1 text-[9px] font-bold tracking-wider ${
                          isStandalone
                            ...
                            : "border-[#F6BA48]/70 bg-[#EFA3C0] text-[#EC4899]"
                        }`}
                      >
                  ...
                  {!isStandalone && (
                    <button
                      ...
                      className="relative mt-auto flex w-full items-center justify-center gap-2 rounded-xl border border-[#F6BA48] bg-gradient-to-r from-pink-500/20 to-rose-500/20 px-4 py-3 text-sm font-black text-white transition-all hover:border-[#F6BA48] hover:from-cyan-500/30 hover:to-purple-500/30 active:scale-[0.99]"
                    >
            ...
            {showInstallHelp && !isStandalone && (
              <div className="mt-4 overflow-hidden rounded-2xl border border-[#F6BA48]/70 bg-[#EFA3C0] shadow-xl shadow-pink-500/10">

                <div className="flex items-start justify-between gap-4 p-5">

                  <div className="flex min-w-0 gap-3">

                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-[#F6BA48]/70 bg-[#EFA3C0]">
                  ...
                  <button
                    ...
                    className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-[#F6BA48]/70 bg-[#EFA3C0] text-[#6A3048] transition hover:bg-[#EFA3C0]/[0.08] hover:text-white"
                  >
                    <X className="h-4 w-4" />
                  </button>
            ...
            <section className="mt-6 grid w-full grid-cols-2 gap-4 md:grid-cols-2">
              ...
              <Link
                href="/likes"
                className="flex h-28 min-w-0 flex-col justify-between rounded-2xl border border-[#F6BA48]/70 bg-[#EFA3C0] p-4 transition-all hover:border-pink-500/40"
              >
              ...
              <Link
                href="/messages"
                className="flex h-28 min-w-0 flex-col justify-between rounded-2xl border border-[#F6BA48]/70 bg-[#EFA3C0] p-4 transition-all hover:border-[#F6BA48]"
              >
