...
export default function Sidebar({ isOpen, onClose }: { isOpen?: boolean; onClose?: () => void }) {
  ...
  /*
   * Burada AYARLAR özellikle bulunmuyor.
   *
   * Çünkü Ayarlar'ı menünün EN ALTINA,
   * Çıkış Yap'ın hemen üstüne taşıyoruz.
   */
    ...
    return (
      ...
      >
        {active && (
          <span
            aria-hidden="true"
            className="absolute bottom-2 left-0 top-2 w-1 rounded-r-full bg-gradient-to-b from-pink-300 via-pink-500 to-rose-600 shadow-[0_0_18px_rgba(244,114,182,0.85)]"
          />
        )}
        ...
        <span
          className={[
            ...
            active
              ? "border-pink-300/45 bg-pink-200/15 text-pink-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]"
              : "border-pink-200/25 bg-pink-100/10 text-[#E8B8CB] group-hover:border-pink-200/50 group-hover:bg-pink-200/15 group-hover:text-white",
          ].join(" ")}
        >
          <Icon
        ...
        <ChevronRight
          className={[
            ...
            active
              ...
              : "-translate-x-1 text-[#C98AA4] opacity-0 group-hover:translate-x-0 group-hover:opacity-100",
          ].join(" ")}
          strokeWidth={2}
        />
      </Link>
  ...
  return (
   <aside className={`fixed inset-y-0 left-0 z-50 flex h-full w-64 flex-col overflow-hidden border-r border-pink-300/30 bg-[#561832] transition-all duration-300 md:sticky md:top-0 md:flex ${isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>
      ...
      <div className="relative z-10 flex h-full min-h-screen flex-col">
          ...
          >
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1">
                ...
                <span className="bg-gradient-to-r from-pink-300 via-pink-500 to-rose-600 bg-clip-text text-[20px] font-black tracking-[-0.04em] text-transparent">
                  VEBEN
                </span>
              </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          <nav aria-label={copy.mainMenu}>
            <p className="mb-2.5 px-3 text-[10px] font-bold uppercase tracking-[0.2em] text-[#C98AA4]">
              {copy.menu}
            </p>
          ...
          <div className="my-5 h-px bg-gradient-to-r from-transparent via-pink-200/25 to-transparent" />
          ...
          <div className="mt-4 flex items-center gap-3 rounded-2xl border border-emerald-400/[0.09] bg-emerald-400/[0.035] px-3.5 py-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-[10px] text-[#C98AA4]">
                {copy.protected}
              </p>
            </div>
          </div>
        ...
        {/* =========================================================
            ...
            AYARLAR → ÇIKIŞ YAP
            ========================================================= */}
        <div className="relative border-t border-pink-200/25 p-4">
          {/* AYARLAR - ARTIK EN ALTTA */}
          <div className="mb-2">
          ...
          <p className="mt-3 text-center text-[9px] font-medium tracking-[0.08em] text-[#B6728E]">
            SenVeBen � 2026
          </p>
        </div>
      </div>
