...
export const metadata: Metadata = {
  ...
  description:
    "SenVeBen, Türkiye'nin 81 ilinden yeni insanlarla tanışmak, arkadaşlık kurmak ve güvenli bağlantılar oluşturmak için modern bir arkadaşlık platformudur.",
  ...
  openGraph: {
    ...
    description:
      "Türkiye'nin 81 ilinden yeni insanlarla tanış, arkadaşlık kur ve güvenli bağlantılar oluştur. SenVeBen'de seni bekleyen insanları keşfet.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "SenVeBen arkadaşlık platformu",
      },
    ],
  },
