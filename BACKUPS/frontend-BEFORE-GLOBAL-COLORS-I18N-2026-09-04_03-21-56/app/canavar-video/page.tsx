...
export default function CanavarVideoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#121420] text-white p-6 flex flex-col justify-between font-sans">
      <div className="text-center border-b border-2 border-[#880e4f]/20 pb-4">
        ...
        <p className="text-[10px] text-slate-400 mt-0.5 tracking-wider uppercase">SENVEBEN.TR KALİTESİNDE GÜVENLİ WEBRTC TÜNELİ
 İlmeği Kalitesinde Güvenli WebRTC Tüneli</p>
      </div>

      <div className="my-auto">
        <div className="w-full aspect-video bg-black/80 rounded-3xl border-2 border-2 border-[#880e4f]/40 overflow-hidden flex items-center justify-center relative shadow-2xl">
