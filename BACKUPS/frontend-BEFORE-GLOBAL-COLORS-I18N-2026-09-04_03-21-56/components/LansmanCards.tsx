...
export default function LansmanCards() {
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#1b1437]/60 via-[#121420]/80 to-[#1b1437]/60 backdrop-blur-md border border-2 border-[#880e4f]/20 rounded-3xl p-5 group transition-all duration-300 hover:border-2 border-[#880e4f]/40">
        <div className="absolute -right-4 -top-4 w-24 h-24 bg-[#f48fb1] rounded-full blur-2xl group-hover:bg-purple-500/20 transition-all duration-300"></div>
        
        <div className="flex items-start gap-4">
          <div className="p-3 bg-[#f48fb1] rounded-2xl text-purple-400 group-hover:scale-110 transition-transform duration-300">
