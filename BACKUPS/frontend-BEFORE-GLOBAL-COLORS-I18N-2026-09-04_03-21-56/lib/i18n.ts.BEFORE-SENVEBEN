...
connectionTitle: "81 İLDEN CANLI VE GÜVENLİ BAĞLANTI MERKEZİ",
  ...
  mobileAppsDesc: "Egelove mobil uygulamaları için çalışmalar devam ediyor. Yakında mağazalarda.",
...
mobileAppsDesc: "We are working on Egelove mobile apps. Coming soon to app stores.",
newLike: "New Like",
active: "Active",
messages: "Messages",
...
mobileAppsDesc: "Мы продолжаем работу над мобильными приложениями Egelove. Скоро в магазинах приложений.",
newLike: "Новый лайк",
active: "Активен",
messages: "Сообщения",
...
mobileAppsDesc: "نعمل على تطبيقات Egelove للهواتف المحمولة. قريبًا في متاجر التطبيقات.",
newLike: "إعجاب جديد",
active: "نشط",
messages: "الرسائل",
